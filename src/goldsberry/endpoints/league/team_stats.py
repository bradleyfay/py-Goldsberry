"""LeagueTeamStats endpoint - fetch league-wide team statistics for a season."""
...
from ...models.league import LeagueTeamStats, TeamStats


class LeagueTeamStatsEndpoint:
    """Fetch league-wide team statistics.
    ...
    This is the league-focused version that returns stats for all teams.
    ...
    Example:
        ...
        ... )
        >>> east_teams = stats.filter_by_conference("East")
    """
    ...
    def _parse_response(self, data: dict) -> LeagueTeamStats:
        """Parse NBA API response into LeagueTeamStats model.

        Args:
            data: Raw API response

        Returns:
            LeagueTeamStats with list of team statistics
        """
        result_sets = data.get("resultSets", [])
        if not result_sets:
            return LeagueTeamStats(teams=[])
        ...
        return LeagueTeamStats(teams=teams)
    ...
    def fetch(
        ...
        **kwargs: Union[str, int],
        ...
        """Fetch league-wide team statistics (synchronous).
        ...
        Returns:
            LeagueTeamStats with all teams' statistics
    ...
    async def fetch_async(
        ...
        **kwargs: Union[str, int],
        ...
        """Fetch league-wide team statistics (asynchronous).
...
def get_league_team_stats(
    ...
    **kwargs: Union[str, int],
    ...
    """Convenience function to fetch league-wide team statistics.
    ...
    Example:
        >>> from goldsberry.endpoints.league import get_league_team_stats
        >>> stats = get_league_team_stats(season="2024-25")
        >>> for team in stats.sort_by_wins()[:5]:
        ...     print(f"{team.team_name}: {team.record}")
    """
    endpoint = LeagueTeamStatsEndpoint()
...
__all__ = ["LeagueTeamStatsEndpoint", "get_league_team_stats"]
